...
class ChefTest < ActiveSupport::TestCase
	def setup
		@chef = Chef.new(name: "test chef",email: "email@example.com")
	end
	...
	test "name shouldn't be more than 30 caracters" do
		@chef.name = "a" * 31
		assert_not @chef.valid?
	end
	...
	test "email shouldn't be more than 255" do
		@chef.email = "a" * 255 + "email@example.com"
		assert_not @chef.valid?
	end
